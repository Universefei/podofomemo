 ...
 */
	...
	PoDoFo::PdfAnnotation* pAnnotation = 
		pPage->CreateAnnotation( PoDoFo::ePdfAnnotation_Link, PoDoFo::Rect(dX, dY, 
	...
	/* 3] Create PdfAction */
	PoDoFo::PdfAction* pAction = 
		new PdfAction( PoDoFo::ePdfAction_URI, document );

	/* 4] Set URI of the action */
	PoDoFo::PdfString* pURI = new PoDoFo::PdfString( &m_sURI);
	pAction->SetURI( pURI );
